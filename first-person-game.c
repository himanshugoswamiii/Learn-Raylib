...
int main(void) {
    ...
    while (!WindowShouldClose()) // Detect window close button or ESC key
    {
        ...
        /*
                ...
                // This new camera function allows custom movement/rotation
           values to be directly provided
           ...
           Move forward-backward (IsKeyDown(KEY_S) || IsKeyDown(KEY_DOWN))*0.1f,
                        (IsKeyDown(KEY_D) || IsKeyDown(KEY_RIGHT))*0.1f -   //
           Move right-left (IsKeyDown(KEY_A) || IsKeyDown(KEY_LEFT))*0.1f, 0.0f
           // Move up-down
                    },
                    (Vector3){
                        GetMouseDelta().x*0.05f,                            //
           Rotation: yaw GetMouseDelta().y*0.05f,                            //
           Rotation: pitch 0.0f // Rotation: roll
                    },
        ...
        */
        ...
        DrawText("- Move keys: W, A, S, D, Space, Left-Ctrl", 15, 30, 10,
                 BLACK);
